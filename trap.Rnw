...
<<label=cytokine_trap,echo=False,fig=False,cache=True>>=
...
<<label=affinity_diff,echo=False,fig=True>>=
...
<<label=affinity_upregulation,echo=False,fig=True>>=
...
<<label=matrix_scan,echo=False,fig=True>>=
...
<<label=tf_scan,echo=False,fig=False,cache=True,eval=True>>=
...
<<label=tf_network,echo=False,fig=False,eval=True>>=
...
<<label=tf_skewt,echo=False,fig=False,cache=True,eval=False>>=
